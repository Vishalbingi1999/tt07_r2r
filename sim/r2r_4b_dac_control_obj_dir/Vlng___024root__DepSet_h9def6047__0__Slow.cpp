...
VL_ATTR_COLD void Vlng___024root___eval_initial__TOP(Vlng___024root* vlSelf) {
    ...
    __Vtemp_1[3U] = 0x5f646163U;
    __Vtemp_1[4U] = 0x725f3462U;
    __Vtemp_1[5U] = 0x7232U;
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(6, __Vtemp_1));
    VL_PRINTF_MT("-Info: ../verilog/rtl/r2r_4b_dac_control.v:17: $dumpvar ignored, as Verilated without --trace\n");
}
